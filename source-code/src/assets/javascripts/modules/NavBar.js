...
export default class NavBar {
  constructor () {
    this.this = '#main-navbar'
    this.$this = $(this.this)
    this.$mainMenu = $('#main-navbar').find('.main-menu-ul')
    this.elementItem = '.hamburger-menu, html, #main-navbar, #header'
    this.$header = $('#header, #main-navbar-mobile')
